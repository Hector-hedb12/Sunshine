...
public class Utility {
    ...
    // Provide the icon resource id according to the weather condition id returned by API
    ...
    // Provide the art resource id according to the weather condition id returned by API
